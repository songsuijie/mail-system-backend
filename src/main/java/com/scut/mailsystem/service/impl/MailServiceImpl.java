...
public class MailServiceImpl implements MailService {
    ...
    private MailAnalysis buildMailAnalysis(Long mailId,
        ...
        try {
            ...
            return buildDefaultMailAnalysis(mailId, recipientId, now);
        }
    }
    ...
    private void insertMailAnalysisSafely(MailAnalysis mailAnalysis, Long mailId, Long recipientId, LocalDateTime now) {
        try {
            ...
            try {
                mailAnalysisMapper.insert(buildDefaultMailAnalysis(mailId, recipientId, now));
    ...
    private MailAnalysis buildDefaultMailAnalysis(Long mailId, Long recipientId, LocalDateTime now) {
        MailAnalysis mailAnalysis = new MailAnalysis();
        mailAnalysis.setMailId(mailId);
        mailAnalysis.setRecipientId(recipientId);
        mailAnalysis.setAnalysisStatus(ANALYSIS_STATUS_SUCCESS);
